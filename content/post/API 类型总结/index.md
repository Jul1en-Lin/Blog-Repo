...
title = "API 类型总结"
slug = "API-类型总结"
date = "2026-06-01T23:35:26+08:00"
lastmod = "2026-06-01T23:35:26+08:00"
draft = false
categories = ["通信协议"]
tags = ["API", "通信协议", "微服务"]
description = "梳理 REST、SOAP、RPC、gRPC、GraphQL、Webhook、SSE、WebSocket、WebRTC、MQTT、AMQP、Kafka、MCP 与 AsyncAPI 的定位和适用场景。"
+++
...
![API 类型之间的关系](assets/api-types/api-relationship-map.jpg)
...
![REST API](assets/api-types/0000-rest-api.jpg)
...
![SOAP API](assets/api-types/0091-soap-api.jpg)
...
![RPC](assets/api-types/0676-rpc.jpg)
...
![gRPC API](assets/api-types/0171-grpc-api.jpg)
...
![GraphQL API](assets/api-types/0280-graphql-api.jpg)
...
![Webhook API](assets/api-types/0373-webhooks-api.jpg)
...
![SSE](assets/api-types/0743-sse.jpg)
...
![WebSocket API](assets/api-types/0451-websockets-api.jpg)
...
![WebRTC API](assets/api-types/0511-webrtc-api.jpg)
...
![MCP Server](assets/api-types/0594-mcp-server.jpg)
...
![MQTT](assets/api-types/0811-mqtt.jpg)
...
![AMQP](assets/api-types/0869-amqp.jpg)
...
![Event-Driven API](assets/api-types/0932-event-driven-api.jpg)
...
![Apache Kafka](assets/api-types/0999-apache-kafka.jpg)
...
![AsyncAPI](assets/api-types/1038-asyncapi.jpg)
