+++
title = "Codex 工作流更新-v2"
slug = "Codex-工作流更新-v2"
date = "2026-05-30T00:00:00+08:00"
draft = false
description = "整理 Codex、Claude Code 和其他 Agent 的项目初始化入口，把 setup-light、setup-full、AGENTS.md、CLAUDE.md 与 checkpoint 工作流拆清楚。"
categories = ["AI"]
tags = ["Codex", "AI", "工作流"]
+++
> 相关博客：[Claude 迁移 Codex 工作流更新]({{< relref "/post/工作流更新/" >}})
