+++
title = "Codex 工作流更新-v3"
slug = "Codex-工作流更新-v3"
date = "2026-06-24T21:49:31+08:00"
lastmod = "2026-06-24T21:49:31+08:00"
draft = false
description = "结合 Codex-maxxing for long-running work，整理长期任务线程、项目记忆、审阅循环、工具使用和 checkpoint 的工作流更新。"
categories = ["AI"]
tags = ["Codex", "AI", "工作流"]
obsidian_path = "/AI/Codex 工作流更新-v3"
+++
> 相关博客：[Codex 工作流更新-v2]({{< relref "/post/Codex 工作流更新-v2/" >}})
...
![Codex goal 命令](assets/codex-goal-command.png)
![Codex loop 命令](assets/codex-loop-command.png)
