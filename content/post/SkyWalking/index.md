...
title = "SkyWalking"
slug = "SkyWalking"
date = "2026-06-15T12:06:13+08:00"
lastmod = "2026-06-15T12:06:13+08:00"
draft = false
categories = ["微服务"]
tags = ["Spring Cloud", "SkyWalking", "微服务", "链路追踪", "APM"]
obsidian_path = "/Spring Cloud/SkyWalking"
description = "整理 SkyWalking 的链路追踪概念、核心组件、Docker Compose 部署、Spring Boot 接入、自定义追踪、日志关联、告警配置和排查顺序。"
+++
# SkyWalking
> 相关笔记：[Spring Cloud 核心概念]({{< relref "/post/核心概念/" >}})
...
![skywalking trace logistics](assets/skywalking-trace-logistics.png)
...
![skywalking java agent startup](assets/skywalking-java-agent-startup.png)
```bash
# 换成自己本地的 agent 安装路径
java \
