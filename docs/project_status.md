...
- The demo uses a fixed left-to-right cover over the second pale botanical background image, with a left-biased `Loading... ✦ — ···` label before normal multi-page navigation.
